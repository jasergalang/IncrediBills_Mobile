...
export default function BillInfoCard({ bill }) {
    return (
        <View className="p-4">
            <LinearGradient
                colors={["#efebff", "#cfc7fe"]}
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 1 }}
                className="rounded-2xl p-5 border-2 border-purple-300"
            >
                <View className="flex-row items-center gap-3 mb-4">
                    <View className="w-14 h-14 bg-purple-500 rounded-2xl items-center justify-center">
                ...
                <View className="bg-white/60 rounded-xl p-4">
                    <View className="flex-row justify-between items-center">
                        ...
                        <View className="flex-1 items-end">
                            <Text className="text-sm text-slate-600 mb-1">Purchase Type</Text>
                            <Text className="text-3xl font-bold text-purple-600">
                                {bill.purchaseType} 
                            </Text>
                        </View>
