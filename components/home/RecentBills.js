    ...
    <View className="px-4 pb-4">
      ...
      <View className="bg-white rounded-2xl p-5 border border-slate-200">
        ...
        {bills.map((bill) => (
          <View
            key={bill.id}
            className={`bg-${bill.backgroundColor} rounded-2xl p-4 mb-3 border border-slate-200`}
          >
            <View className="flex-row items-center gap-3">
              ...
              <View className="items-end">
                ...
                <View
                  className={`px-2 py-1 rounded-full mt-1 ${bill.status === "Success" ? "bg-green-100" : "bg-red-100"
                    }`}
                >
                  <Text
