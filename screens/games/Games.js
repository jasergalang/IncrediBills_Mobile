        ...
        <View className="px-4 py-4">
          <View className="flex-row gap-3">
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text className={`text-center font-bold text-sm ${activeTab === "quests" ? "text-white" : "text-slate-600"}`}>
                🎯 Active Quests
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text className={`text-center font-bold text-sm ${activeTab === "achievements" ? "text-white" : "text-slate-600"}`}>
                🏆 Achievements
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <View className="px-4 pb-6">
            <View className="flex-row items-center justify-between mb-4">
              <View className="flex-row items-center">
                ...
                <Text className="text-lg font-bold text-slate-900">Monster Battles</Text>
              </View>
              <TouchableOpacity className="bg-green-500 px-3 py-2 rounded-lg">
                <Text className="text-white font-semibold text-xs">+ New Quest</Text>
              </TouchableOpacity>
          ...
          <View className="px-4 pb-6">
            <View className="flex-row items-center justify-between mb-4">
              <View className="flex-row items-center">
                ...
                <Text className="text-lg font-bold text-slate-900">Trophy Collection</Text>
              </View>
              <View className="flex-row gap-2">
                <TouchableOpacity className="bg-white border border-slate-200 px-3 py-2 rounded-lg">
                  <Text className="text-slate-700 font-semibold text-xs">All</Text>
            ...
            <LinearGradient
              ...
              className="rounded-2xl p-6 mt-4"
            >
              <Text className="text-xl font-bold text-white mb-2">Share Your Achievements!</Text>
              <Text className="text-white/90 text-sm mb-4">
                Show off your eco-warrior status to your friends
              </Text>
              <View className="flex-row gap-2">
